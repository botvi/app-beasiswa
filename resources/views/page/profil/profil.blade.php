            ...
            @if ($user)
                <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                <img alt="image" class="img-fluid rounded-circle"
                                    src="{{ asset($mahasiswa->user->image ?? '') }}"
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="{{ route('mhs.update', ['id' => $mahasiswa->id]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('nim') is-invalid @enderror"
                                                    id="nim" name="nim" placeholder="NIM" required type="text"
                                                    value="{{ $mahasiswa->nim }}">
                                                @error('nim')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('nama') is-invalid @enderror"
                                                    id="nama" name="nama" placeholder="Nama" required type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                                    id="tanggal_lahir" name="tanggal_lahir" required type="date"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('telepon') is-invalid @enderror"
                                                    id="telepon" name="telepon" placeholder="Telepon" required
                                                    type="text" value="{{ $mahasiswa->telepon }}">
                                                @error('telepon')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('program_studi') is-invalid @enderror"
                                                    id="program_studi" name="program_studi" required>
                                                    <option disabled selected value="">-- Pilih Program Studi --
                                                    </option>
                                                    <option
                                                        {{ $mahasiswa->program_studi === 'Program Studi 1' ? 'selected' : '' }}
                                                        value="Program Studi 1">Program Studi 1</option>
                                                    <option
                                                        {{ $mahasiswa->program_studi === 'Program Studi 2' ? 'selected' : '' }}
                                                        value="Program Studi 2">Program Studi 2</option>
                                                    <option
                                                        {{ $mahasiswa->program_studi === 'Program Studi 3' ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('ipk') is-invalid @enderror"
                                                    id="ipk" name="ipk" placeholder="IPK" required
                                                    type="text" value="{{ $mahasiswa->ipk }}">
                                                @error('ipk')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('username') is-invalid @enderror"
                                                    ...
                                                    type="text" value="{{ $mahasiswa->user->username ?? '' }}">
                                                @error('username')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
